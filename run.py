...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='MDFM-AdaKAN')
<<<<<<< HEAD
    ...
    parser.add_argument('--model', type=str, required=True, default='MDFM-AdaKAN',
    ...
    parser.add_argument('--use_adaptiveloss', default=False, action="store_true")
